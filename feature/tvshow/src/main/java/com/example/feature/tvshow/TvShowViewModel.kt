...
/*
    ...
    private val _listState = MutableStateFlow<List<com.example.core.model.TvShowModel>>(listOf())
    val listState: StateFlow<List<com.example.core.model.TvShowModel>> get() = _listState
    ...
    private fun handleData(newResult: com.example.core.model.ListModel<com.example.core.model.TvShowModel>) {
