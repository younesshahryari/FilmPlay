...
fun TvShowDetailResponse.toTvShowDetailModel(): TvShowDetailModel {
    return TvShowDetailModel(
        ...
        lastEpisodeResponseToAir = lastEpisodeResponseToAir?.toEpisodeModel(),
        nextEpisodeResponseToAir = nextEpisodeResponseToAir?.toEpisodeModel(),
        ...
        posterPath = posterPath,
        seasonResponses = seasonResponses?.map { it.toSeasonModel() },
        status = status,
        tagline = tagline,
        type = type,
        voteAverage = voteAverage,
